    ...
    >
      <Link
        ...
        className={`px-4 py-2 rounded-full text-gray-100 hover:text-indiaSaffron transition-colors duration-200 text-sm font-medium flex items-center space-x-1 ${
                ...
                location.pathname.startsWith("/about/introduction") ||
                location.pathname.startsWith("/about/organization") ||
                location.pathname.startsWith("/about/movement") ||
                location.pathname.startsWith("/about/our-founder") ||
                location.pathname.startsWith("/about/philosophy")
