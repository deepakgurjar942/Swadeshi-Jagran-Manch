...
const AgriculturePage = () => {
    ...
    const {
        ...
        paginate,
        getPageNumbers,
    } = usePagination({ items: agriculture, itemsPerPage: 6 });
        ...
        <div className="min-h-screen mt-36 bg-gradient-to-b from-gray-50 to-gray-100">
            ...
            <section className="max-w-7xl mx-auto px-4 py-12 -mt-10">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 mb-10">
                    <h2 className="text-3xl font-bold text-gray-800 border-l-6 border-green-600 pl-3 mb-2">
                        Agriculture
                    </h2>
                    <p className="text-gray-600">
                        Explore our collection of agriculture-related articles and resources
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {currentItems.map((article ,idx) => (
                        <div key={idx} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group border border-gray-100">
...
>>>>>>> a18891c1e5bf493d2d8f8b4eead2c1f9f2955497
                        ...
                        <p className="text-xl md:text-2xl text-gray-700 italic font-serif mt-8 leading-relaxed">
                            Dive into our curated collection of articles on sustainable agriculture, traditional farming practices, and the Swadeshi movement's impact on rural livelihoods.
                        </p>
                    </div>
                </div>
