...
const EditorialPage = () => {
    ...
    const {
        ...
        paginate,
        getPageNumbers,
    } = usePagination({ items: editorials, itemsPerPage: 6 });
...
>>>>>>> a18891c1e5bf493d2d8f8b4eead2c1f9f2955497
                        ...
                        <p className="text-xl md:text-2xl text-gray-700 italic font-serif mt-8 leading-relaxed">
                            Explore insightful editorial articles on current affairs, economic independence, and sustainable living curated by thought leaders and activists.
                        </p>
                    </div>
                </div>
