...
const GmDebatePage = () => {
    ...
    const {
        ...
        paginate,
        getPageNumbers,
    } = usePagination({ items: gmDebate, itemsPerPage: 6 });
            ...
            <section className="max-w-7xl mx-auto px-4 py-12 -mt-10">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 mb-10">
                    ...
                    <p className="text-gray-600">
                        Explore the ongoing debate surrounding Genetically Modified (GM) crops and their impact on agriculture, environment, and society.
                    </p>
                </div>

                {/* Articles Grid */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {GmDebate.map(article => (
...
>>>>>>> a18891c1e5bf493d2d8f8b4eead2c1f9f2955497
                        ...
                        <p className="text-xl md:text-2xl text-gray-700 italic font-serif mt-8 leading-relaxed">
                            Explore insightful GmDebate articles on genetic modification, biotechnology, and sustainable agriculture curated by experts and activists.
                        </p>
                    </div>
                </div>
