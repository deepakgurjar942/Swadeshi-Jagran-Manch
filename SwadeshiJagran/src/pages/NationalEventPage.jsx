...
import { nationalEvents } from '../services/nationalEvents';
...
const NationalEventPage = () => {
    ...
    const {
        ...
        paginate,
        getPageNumbers,
    } = usePagination({ items: nationalEvents, itemsPerPage: 6 });
            ...
            <section className="max-w-7xl mx-auto px-4 py-12 -mt-10">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 mb-10">
                    ...
                    <p className="text-gray-600">
                        Stay updated with the latest national events and happenings
                    </p>
                </div>
...
>>>>>>> a18891c1e5bf493d2d8f8b4eead2c1f9f2955497
                        ...
                        <p className="text-xl md:text-2xl text-gray-700 italic font-serif mt-8 leading-relaxed">
                            Discover comprehensive coverage of national events shaping our country. From political developments to cultural celebrations, stay informed with in-depth articles and expert analyses on the issues that matter most to India.
                        </p>
                    </div>
                </div>
                        ...
                        <div className="lg:col-span-3">
                            ...
                            <div className="bg-white rounded-3xl shadow-2xl p-8 border border-amber-100 mb-8">
                                <h2 className="text-2xl font-bold mb-6 text-gray-800 flex items-center">
                                    ...
                                    Latest National Event Articles
                                </h2>
...
export default NationalEventPage;