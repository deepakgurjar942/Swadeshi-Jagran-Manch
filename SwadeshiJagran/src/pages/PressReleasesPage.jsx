...
import { pressArticles } from '../services/press';
...
const PressReleasesPage = () => {
    ...
    const {
        ...
        paginate,
        getPageNumbers,
    } = usePagination({ items: pressArticles, itemsPerPage: 6 });
            ...
            <section className="max-w-7xl mx-auto px-4 py-12 -mt-10">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 mb-10">
                    ...
                    <p className="text-gray-600">
                        Stay informed with our curated collection of articles on press releases
                    </p>
                </div>
...
>>>>>>> a18891c1e5bf493d2d8f8b4eead2c1f9f2955497
                        ...
                        <p className="text-xl md:text-2xl text-gray-700 italic font-serif mt-8 leading-relaxed">
                            Stay informed with the latest press releases from Swadeshi Jagran Manch. Our Press Release section provides official statements, updates, and insights on key issues related to economic independence, sustainable development, and national progress.
                        </p>
                    </div>
                </div>
