...
import { sbAbhiyanArticles } from '../services/sb-abhiyan';
...
const SbAbhiyanPage = () => {
    ...
    const {
        ...
        paginate,
        getPageNumbers,
    } = usePagination({ items: sbAbhiyanArticles, itemsPerPage: 6 });
            ...
            <section className="max-w-7xl mx-auto px-4 py-12 -mt-10">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 mb-10">
                    ...
                    <p className="text-gray-600">
                        Empowering India through self-reliance and sustainable development
                    </p>
                </div>
                    ...
                    <div className="text-center mb-12 max-w-4xl">
                        <div className="inline-block relative">
                            <h1 className="font-bold text-gray-900 text-4xl sm:text-5xl lg:text-6xl mb-8 relative z-10">
                                Swavalambi Bharat Abhiyan Articles
                            </h1>
...
>>>>>>> a18891c1e5bf493d2d8f8b4eead2c1f9f2955497
                        ...
                        <p className="text-xl md:text-2xl text-gray-700 italic font-serif mt-8 leading-relaxed">
                            Explore insightful articles on economic independence, sustainable development, and self-reliance curated by thought leaders and activists.
                        </p>
                    </div>
                </div>
                        ...
                        <div className="lg:col-span-3">
                            ...
                            <div className="bg-white rounded-3xl shadow-2xl p-8 border border-amber-100 mb-8">
                                <h2 className="text-2xl font-bold mb-6 text-gray-800 flex items-center">
                                    ...
                                    Latest Swavalambi Bharat Abhiyan Articles
                                </h2>
