...
import { standOnIssue } from '../services/standOnIssue';
...
const StandOnIssue = () => {
    ...
    const {
        ...
        paginate,
        getPageNumbers,
    } = usePagination({ items: standOnIssue, itemsPerPage: 6 });
                ...
                <div className="container-fluid pt-28 pb-12 flex flex-col items-center px-4 sm:px-6 lg:px-12">
                    <div className="text-center mb-12 max-w-4xl">
                        ...
                        <p className="text-xl md:text-2xl text-gray-700 italic font-serif mt-8 leading-relaxed">
                            "Empowering Voices, Shaping Futures: Our Stand on Key Issues"
                        </p>
                    </div>
                </div>
